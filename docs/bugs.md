...
### Скриншот
![При выборе красной темы в сгенерированном iframe-коде отсутствует параметр theme](../artifacts/screenshots/BUG-01-красная-тема-отсутствует-в-сгенерированном-коде.png)
...
### Скриншот
![Отсутствует приоритезация выбора высоты при переключении в режим на всю высоту блока](../artifacts/screenshots/BUG-02-приоритезация-выбора-в-поле-Высота.png)
